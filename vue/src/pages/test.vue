...
<!--            </el-card><br /><br /><br />-->
<!--          </el-col>-->
<!--          &lt;!&ndash; <el-button type="info" plain style="width: 100%;height: 1.5rem;font-size: 0.5rem;text-align: left;-->
<!--          background-image: url(../../../static/image/tomb2.jpg);">在 Steam 上查看 “Tomb Raider” 全系列作品</el-button>-->
<!--          <br /><br /><br /> &ndash;&gt;-->
<!--          &lt;!&ndash; 				 <el-button type="success" style="width: 100%;height: 1.5rem;font-size: 0.5rem;-->
...
<!--              </el-tab-pane>-->
<!--            </el-tabs>-->
<!--            &lt;!&ndash; <el-tabs type="border-card">-->
...
<!--      <el-col :xs="0" :sm="1" :md="2" :lg="3" :xl="2"><div class="grid-content "></div></el-col>-->
<!--    </el-row>-->
<!--    &lt;!&ndash; <img src="../../../static/image/tomb1.jpg" /> &ndash;&gt;-->
<!--  </div>-->
<!--</template>-->
